...
app.config['SECRET_KEY'] = 'imgonnanailthisinterview'
...
def rps_game():
    if(game.is_in_progress):
        if(game.winner == 'Bot'):
            flash('You lose! Bot takes the point', category='lose')
        elif(game.winner == "Draw"):
            flash('Tie! No point awarded!', category='draw')
        else:
            flash('Nice job! You take the point!', category='win')
